...
const WeatherCard = ({
  ...
  return (
    <div className='w-[22rem] min-w-[22rem] h-[32rem] glassCard p-4'>
      <div className='flex w-full just-center, items-center gap-4 mt-6 mb-4'>
      ...
      <div className='w-full bg-gray-600 shadow rounded-lg flex justify-between mt-4 items-center'>
        <p className='flex-1 font-bold text-center p-2'>{new Date().toDateString()}</p>
        <p className='flex-1 font-bold text-center p-2'>{time}</p>
      </div>
